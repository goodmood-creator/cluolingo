...
Esto enlaza la CLI `cluo` en tu PATH, instala el comando de barra `/btw` y conecta el hook en `~/.claude/settings.json`. Reejecuta cuando quieras; desinstala con `./install.sh --uninstall`.
